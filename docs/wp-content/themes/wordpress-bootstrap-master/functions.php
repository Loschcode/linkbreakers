...
// Load API Mustache for Linkbreakers
//require_once($template_dir . '/includes/api/api.php');
...
function first_paragraph( $content ){
    ...
    if( is_page_template( 'page-homepage.php' ) )
        ...
        return preg_replace('/<p([^>]+)?>/', '<p$1 class="lead-no">', $content, 1);
}
    ...
    {     
        ...
        {    
            ...
            if ($item->hasChildren && $depth == 0) { 
                $item_output .= '<a'. $attributes .'data-hover="dropdown" data-delay="1000" data-close-others="true" class="dropdown-toggle">'; // data-toggle="dropdown"
            } else { 
...
if( !function_exists("theme_styles") ) {  
    function theme_styles() { 
        ...
        wp_register_style( 'layout', get_template_directory_uri() . '/library/css/layout.css', array(), '1.0', 'all' );
